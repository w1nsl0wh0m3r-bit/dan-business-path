...
<section>
<h2>August 8 Italian caffè document gate: one advance, one hold, one kill.</h2>
<div class="note" style="margin-bottom:24px"><b>Updated 2026-08-08.</b> The document-gate sprint supersedes the initial three-lead ranking. Angelina advances only to reconciliation of the raw 2026 FDD; Rosetta holds until private ownership/JV documents exist; Pappalecco is killed for proactive platform work. None is investable, and employment clearance remains a hard gate before outreach.</div>
<div class="grid3">
<div class="card"><h3>ADVANCE: Angelina Bakery</h3><p>Proceed only to raw-2026-FDD reconciliation. Compare the current disclosure against the captured 2025 document, resolve AUV and franchisor-versus-franchisee economics, and verify entity/IP continuity. This is a document review, not authorization to approach the company.</p></div>
